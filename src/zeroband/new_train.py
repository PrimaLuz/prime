...
def train(config: Config):
    ...
    with sw.record_block("Shard Model"):
        ...
        use_hier = int(os.getenv("ZERO_BAND_INNER_NODES_PER_GROUP", "1")) > 1
        mesh_cls = HierarchicalDeviceMesh if use_hier else ElasticDeviceMesh
        elastic_device_mesh = mesh_cls(
